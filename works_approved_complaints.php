...
<body>
                ...
                <div class="nav-link-div">
                    ...
                    <a href="works-dashboard.php">
                        ...
                        <a href="works_approved_complaints.php">
                            <li class="active"><i class="bi bi-map"></i>Approved Complaints</li>
                        </a>
        ...
        <div class="main-body">
            <div class="main-body-real">
                <div class="main-body-sub">
                    <p class="main-body-sub-p">Approved Complaints</p>
                            ...
                            <div class="hostel-main-table-sub">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $querym = "SELECT * FROM complaint WHERE comments = 'Approved by works directory' OR comments = 'Completed by works directory' ORDER BY date_time DESC";
    ...
    xhr.open("POST", "get_approved.php", true);
    xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhr.onload = function() {
        if (xhr.status === 200) {
            window.location.href = "works_approved_complaints.php";
        } else {
            // Handle error
