                ...
                <div class="nav-link-div">
                    ...
                    <a href="works-dashboard.php">
                        ...
                        <a href="works_rejected_complaints.php">
                            <li class="active"><i class="bi bi-kanban"></i>Rejected Complaints</li>
                        </a>
        ...
        <div class="main-body">
            <div class="main-body-real">
                <div class="main-body-sub">
                    <p class="main-body-sub-p">Rejected Complaints</p>
                            ...
                            <div class="hostel-main-table-sub">
                                <table>
                                    ...
                                    <?php
                                        ...
                                        $querym = "SELECT * FROM complaint WHERE comments = 'Rejected by works directory' ORDER BY date_time DESC";
